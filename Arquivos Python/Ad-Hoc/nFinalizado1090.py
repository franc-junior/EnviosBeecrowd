...
###############################################################################################################################   
    ...
    # if (um_circulo+dois_circulo+tres_circulo)>=3:
    #     v = (um_circulo+dois_circulo+tres_circulo)//3
    #     cont+=v
    #     um_circulo-=v
    #     dois_circulo-=v
    #     tres_circulo-=v
    # if (um_quadrado+dois_quadrado+tres_quadrado)>=3:
    #     v = (um_quadrado+dois_quadrado+tres_quadrado)//3
    #     cont+=v
    #     um_quadrado-=v
    #     dois_quadrado-=v
    #     tres_quadrado-=v
    # if (um_triangulo+dois_triangulo+tres_triangulo)>=3:
    #     v = (um_triangulo+dois_triangulo+tres_triangulo)//3
    #     cont+=v
    #     um_triangulo-=v
    #     dois_triangulo-=v
    #     tres_triangulo-=v

    v = (um_circulo + um_quadrado + um_triangulo)//3
    cont+=v
    v = (dois_circulo + dois_quadrado + dois_triangulo)//3
    cont+=v
    v = (tres_circulo + tres_quadrado + tres_triangulo)//3
    cont+=v
